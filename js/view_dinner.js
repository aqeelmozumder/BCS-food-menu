...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    try {
        ...
        // Get the Dinner for today's day
        const dinner = data[today] ? data[today].Dinner : 'No service today.';
        
        // Insert the dinner content into the page
        mealContainer.innerHTML = `<h1>Dinner Today: ${dinner}</h1>`;
    } catch (error) {
